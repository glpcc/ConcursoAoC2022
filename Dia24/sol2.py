...
walls: set[tuple[int,int]] = {(1,-1),(150,22)}
...
def calculate_time(start_pos, ending_pos, ls:set[tuple[int,int]],rs: set[tuple[int,int]],ds: set[tuple[int,int]],us: set[tuple[int,int]]):
    left_storms,right_storms,down_storms,up_storms = ls,rs,ds,us
    mins = 0
    done = False
    ...
    while not done and len(open_positions) > 0:
        ...
        mins += 1
    return mins,left_storms,right_storms,down_storms,up_storms

mins1,left_storms,right_storms,down_storms,up_storms = calculate_time(starting_pos,ending_pos,left_storms,right_storms,down_storms,up_storms)
print(mins1)
mins2,left_storms,right_storms,down_storms,up_storms = calculate_time(ending_pos,starting_pos,left_storms,right_storms,down_storms,up_storms)
print(mins2)
mins3,left_storms,right_storms,down_storms,up_storms = calculate_time(starting_pos,ending_pos,left_storms,right_storms,down_storms,up_storms)
print(mins3)
print(mins1+mins2+mins3)