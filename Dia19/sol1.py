...
def calculate_num_geodes(robot: int,blueprint: dict, info: tuple = (24,1,0,0,0,0,0,0,0,0)):
    # print(list_robots)
    mins = info[0]
    ore_robots = info[1]
    clay_robots = info[2]
...
test_cache = {}
def calculate_max(next_item,blueprint,list_length,info = (24,1,0,0,0,0,0,0,0,0)):
